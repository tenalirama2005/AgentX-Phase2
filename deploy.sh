...
if [ "$RUN_PIPELINE" = true ]; then
    ...
    yellow "  Forty Nine AI models voting in parallel..."
    echo ""
...
# Fetch per-node FBA report
    if [ -n "$REVIEW" ]; then
        ...
        echo ""
        cyan "================================================="
        cyan " FBA Node Results -- Forty Nine Models arxiv:2507.11768"
        cyan "================================================="
